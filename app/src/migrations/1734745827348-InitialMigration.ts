...
export class InitialMigration1734745827348 implements MigrationInterface {
    name = 'InitialMigration1734745827348'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "note" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "content" text NOT NULL, "color" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "tags" text, "calendarDate" TIMESTAMP, "userId" integer, CONSTRAINT "PK_96d0c172a4fba276b1bbed43058" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_shared_notes_note" ("userId" integer NOT NULL, "noteId" integer NOT NULL, CONSTRAINT "PK_02bd6c4e621f6458b40e3651eaa" PRIMARY KEY ("userId", "noteId"))`);
